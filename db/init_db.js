...
async function populateInitialData() {
  try {
    ...
    const product1 = await Products.createProduct({
      ...
      description:
        "The infamous original, no introduction needed. Created years before the current craze, this exclusive NFT pre-dates all others by decades. It's value shines bright and intense like the desert sun",
      price: "999.99",
      image:

...
async function populateInitialData() {
  ...
  try {
    ...
    const product2 = await Products.createProduct({
      ...
      description: "It's just camel and it's a picture. You can't get more simple than that. Just good, clean LEGAL fun. Hand-drawn by a world renown artist, 8 year old Tommy who is probably your friend's brother or nephew or something.",
      price: "110.99",
    ...
    const product3 = await Products.createProduct({
      title: "camelCase NFT",
      description: "It's a digital picture of a camel phone case. If it actually existed it would be a good investment to protect your cellular phone from drops and spills.",
      price: "39.99",
    ...
    const product4 = await Products.createProduct({
      ...
      description: "An original camelCase camel phone case. It's actually a real phone case! This one is just a prototype and not available for sale as of yet but you can pre-oder it here! Pre-orders are great and have proven to be worth it time and time again.",
      price: "399.99",
    ...
    const product5 = await Products.createProduct({
      ...
      description:
        "A one of a kind, unique digital thing that for sure has meaning. Be careful: buy at your own risk! This one can be high risk, high reward. For those trying to break into the lucrative NFT world but like to live dangerously.",
      price: "199.99",
    ...
    const product6 = await Products.createProduct({
      ...
      description:
        "A two for one deal, a camelCase original NFT AND the pride of owning it, all in one! The middle of the week is the ultimate glass half full or empty example. Are you a pessimist or an optimist? This exclusive deal will help you find out!",
      price: "19.99",
    ...
    const product7 = await Products.createProduct({
      ...
      description:
        "It doesn't actually hold water but you get the idea that if it was real, it probably could hold water. It has a really chic A E S T H E T I C that will definitely increase your cool level by a factor of exactly 1. No drinking of actual water required!",
      price: "259.99",
    ...
    const product8 = await Products.createProduct({
      ...
      description: "A homage to our humble namesake's natural habitat. Do you remember playing with those sand color kits when you were a kid? This is a perfect gift to remind someone of how old they are while also paying tribute to the beautiful landscape that inspired it!",
      price: "489.99",
    ...
    const product9 = await Products.createProduct({
      ...
      description: "WARNING: Will break a back if not placed properly! Avoid placing on someone's back while also avoiding the cracks in the ground for the sake of your mother.",
      price: "105.99",
